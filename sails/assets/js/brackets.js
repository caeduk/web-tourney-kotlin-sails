...
(function($){
    var get_html_player = function(player){
            ...
            if( player.url ){
                html_player += '        <a class="nome" href="' + player.url + '">';
                html_player += '           ' + player.nome;
                html_player += '        </a>';
            }else{
                html_player += '           ' + player.nome;
            }
        ...
        get_html_match = function(match){
            ...
            if(match.equipe1)
            html_match += get_html_player(match.equipe1);

            if(match.equipe2)
            html_match += get_html_player(match.equipe2);
        ...
        set_style = function(styles, n_brackets){
            ...
            css += "                .container-brackets .round .match .player .nome{";
